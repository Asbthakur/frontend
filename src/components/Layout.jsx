...
const Layout = ({ children }) => {
  ...
  // Navigation items - different for logged in vs anonymous users
            ...
            <div className="px-4 py-4 space-y-2">
              ...
              {isAuthenticated ? (
                ...
                <Link
                  to="/login"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full flex items-center space-x-3 px-4 py-3 text-primary-600 hover:bg-primary-50 rounded-lg transition-all"
                >
                  <LogIn className="w-5 h-5" />
                  <span className="font-medium">Sign In</span>
                </Link>
